...
Walk With Tyson consists of four pages: [Home](index.html) is the main laoding page, [Tyson's Life](Tysons-Life.html), [Images](images.html), [Walkies](Walkies.html) and a Thank You message that pops up when a user sign up for walks. All the four pages are all accessible from navigation bar except for the secret Thank You page. The header is responsive and will return the user to home page when used. Links to social media are placed at the footer of every page.
...
![Thank You](readme-images/thank_you.png)
...
* CSS Validator: [Result here](https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2Fivane212.github.io%2FWalk-With-Tyson%2F&profile=css3svg&usermedium=all&warning=1&vextwarning=&lang=en)
